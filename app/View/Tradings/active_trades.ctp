							...
							<td>
                                ...
                                <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <?php } ?>
                                            <li><?php echo $this->Html->link('<i class="fa fa-edit"></i> Edit Profit/Lose',array('controller'=>'tradings','action'=>'edit_profit_loss',$data['RobotTrade']['id']),array('escape'=>false,'title'=>'Edit Profit/Lose')); ?></li>

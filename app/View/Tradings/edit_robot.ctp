<div class="row">
  <div class="col-md-7">
                ...
                <section class="widget">
                    <header>
                        <h4><i class="fa fa-user"></i> Robot <small>Edit Robot</small></h4>
                    </header>
                    <div class="body">
					   ...
					   <?php echo $this->Form->create('Robot',array('url'=>'/tradings/edit_robot','class'=>'form-horizontal form-label-left')); 

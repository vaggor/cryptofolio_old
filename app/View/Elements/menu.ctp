...
<nav id="sidebar" class="sidebar nav-collapse collapse">
            <ul id="side-nav" class="side-nav">
                ...
                <li class="panel">
                    <a class="accordion-toggle collapsed" data-toggle="collapse"
                       data-parent="#side-nav" href="#menu-levels-collapse"><i class="fa fa-folder-open"></i> <span class="name">Trades</span></a>
                    <ul id="menu-levels-collapse" class="panel-collapse collapse">
                ...
                <li class="panel">
                    <a class="accordion-toggle collapsed" data-toggle="collapse"
                       data-parent="#side-nav" href="#report-collapse"><i class="fa fa-area-chart"></i> <span class="name">Reports</span></a>
                    <ul id="report-collapse" class="panel-collapse collapse">
                        <li><?php echo $this->Html->link('Trans Reports',array('controller'=>'reports','action'=>'index')); ?></li>
                        <li><?php echo $this->Html->link('Daily Reports',array('controller'=>'reports','action'=>'daily_report')); ?></li>
                        <li><?php echo $this->Html->link('Monthly Reports',array('controller'=>'reports','action'=>'monthly_report')); ?></li>
                        <li><?php echo $this->Html->link('Yearly Report',array('controller'=>'reports','action'=>'yearly_report')); ?></li>
                    </ul>
                </li>

                <li class="">
                    
                    <a href="https://clickmegh.com/cryptofolio/files/help.pdf" target="_blank"><i class="fa fa-briefcase"></i> <span class="name">Help</span></a>          
                </li>

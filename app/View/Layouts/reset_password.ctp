...
<body>
		...
		<center style=" margin-top:50px;"><div style="width: 450px;margin-bottom: 10px;"><?php echo $this->Session->flash(); ?></div></center>
            <section class="widget login-widget">
                ...
                <div class="body">
					...
					<?php echo $this->Form->create('User',array('url'=>'/users/reset_password','class'=>'no-margin')); ?>
                        <fieldset>
                ...
                <footer>
                    <div class="facebook-login">
						...
						<?php echo $this->Html->link('<span><i class="fa fa-user fa-lg"></i> Login',array('controller'=>'users','action'=>'login'),array('class'=>'forgot','escape'=>false)); ?>
                    </div>
                </footer>
            </section>
        </div>

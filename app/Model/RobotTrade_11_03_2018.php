...
class RobotTrade extends AppModel{
	...
	public function countAllActiveTradeByUserByMonth($user_id,$date){
		//print_r($symbol);exit;
		return $this->find('count', array('conditions'=>array('deleted'=>0,'user_id'=>$user_id,'status'=>4,'last_updated like'=>$date.'%')));
	}
	...
	public function countAllClosedTradeByUserByMonth($user_id,$date){
		//print_r($symbol);exit;
		return $this->find('count', array('conditions'=>array('deleted'=>0,'user_id'=>$user_id,'status'=>5,'last_updated like'=>$date.'%')));
	}
	...
	public function getProfitByUserWithoutRobotByMonth($user_id,$date){
		return $this->find('all', array('conditions'=>array('deleted'=>0,'user_id'=>$user_id,'status'=>5,'last_updated like'=>$date.'%'),'fields'=>array('sum(RobotTrade.perc_profit) as tot_perc_profit','sum(RobotTrade.profit) as tot_profit')));
	}
